...
!function (context) {
  ...
  aug(ender, {
    ...
    fn: context.Ender && context.Ender.fn || {} // for easy compat to jQuery plugins
  });
  ...
  aug(boosh, {
    ...
    Ender: ender // handy reference to self
  });

  var old = context.Ender;
  ...
  context['ender'] = context['Ender'] = context['ender'] || ender;
